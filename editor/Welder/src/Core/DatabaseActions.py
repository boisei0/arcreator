...
class DatabaseAction(Actions.ActionManager):
    ...
    def apply_keys(self):
        ...
        try:
            ...
            Kernel.Log("Exception applying Database Action(%s), will atempt to revert" % self.type, "[DatabaseAction]",
                       True, True)
            try:
                ...
                Kernel.Log(
                    "Exception reverting failed 'Apply' Database Action(%s), Possible Project coruption" % self.type,
                    "[DatabaseAction]", True, True)
        return False
    ...
    def undo_keys(self):
        ...
        try:
            ...
            Kernel.Log("Exception undoing Database Action(%s), will atempt to revert" % self.type, "[DatabaseAction]",
                       True, True)
            try:
                for key in keys_applyed:
                ...
                Kernel.Log(
                    "Exception reverting failed 'Undo' Database Action(%s), Possible Project coruption" % self.type,
                    "[DatabaseAction]", True, True)
        return False
    ...
    def apply_extra(self):
        ...
        try:
            if self.data.has_key("parameters"):
                self.parameters_action = KM.get_component("TableEditAction").object(self.obj.parameters,
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Apply' Actor Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Undo' Actor Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
    ...
    def apply_extra(self):
        ...
        try:
            if self.data.has_key("element_ranks"):
                self.element_ranks_action = TableEditAction(self.obj.element_ranks, self.data["element_ranks"],
                                                            sub_action=True)
            ...
            if self.data.has_key("state_ranks"):
                self.state_ranks_action = TableEditAction(self.obj.state_ranks, self.data["state_ranks"],
                                                          sub_action=True)
                result &= self.element_ranks_action.apply()
                actions_now.append(self.element_ranks_action)
                if not result:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Apply' Class Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Undo' Class Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
...
class WeaponEditAction(DatabaseAction):
    ...
    def __init__(self, obj, data={}, sub_action=False):
        super(WeaponEditAction, self).__init__(data, sub_action)
        self.setType("Weapon")
        self.setObj(obj)
        self.addKeys("id", "name", "icon_name", "description", "animation1_id", "animation2_id", "price", "atk", "pdef",
                     "mdef", "str_plus", "int_plus", "dex_plus", "agi_plus", "element_set", "plus_state_set",
                     "minus_state_set")
...
class AnimationFrameEditAction(DatabaseAction):
    ...
    def apply_extra(self):
        ...
        try:
            if self.data.has_key("cell_data"):
                self.cell_data_action = KM.get_component("TableEditAction").object(self.obj.cell_data,
                                                                                   self.data["cell_data"],
                                                                                   sub_action=True)
            ...
            Kernel.Log("Exception applying Animation Frame Edit Action, will atempt to revert", "[DatabaseAction]",
                       True, True)
            try:
                for action in actions_now:
                    test = action.undo()
                ...
                Kernel.Log("Exception reverting failed 'Apply' Animation Frame Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            ...
            Kernel.Log("Exception undoing Animation Frame Edit Action, will atempt to revert", "[DatabaseAction]", True,
                       True)
            try:
                for action in actions_now:
                    test = action.apply()
                ...
                Kernel.Log("Exception reverting failed 'Undo' Animation Frame Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
    ...
    def apply_extra(self):
        ...
        try:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Apply' Enemy Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Undo' Enemy Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
    ...
    def apply_extra(self):
        ...
        try:
            if self.data.has_key("data"):
                ...
                if not result:
                    raise StandardError("'Apply' Sub action failed: %s" % self.data_action)
        except StandardError:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Apply' Map Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            if self.data_action is not None:
                ...
                actions_now.append(self.data_action)
                if not result:
                    raise StandardError("'Undo' Sub action failed: %s" % self.data_action)
        except StandardError:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Undo' Map Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
...
class StateEditAction(DatabaseAction):
    ...
    def __init__(self, obj, data={}, sub_action=False):
        ...
        self.setType("State")
        self.setObj(obj)
        self.addKeys('id', 'name', 'animation_id', 'restriction', 'nonresistance', 'zero_hp', 'cant_get_exp',
                     'cant_evade',
                     'slip_damage', 'rating', 'hit_rate', 'maxhp_rate', 'maxsp_rate', 'str_rate', 'dex_rate',
                     'int_rate',
...
class SystemEditAction(DatabaseAction):
    ...
    def __init__(self, obj, data={}, sub_action=False):
        ...
        self.setType("System")
        self.setObj(obj)
        self.addKeys('magic_number', 'party_members', 'elements', 'switches', 'variables', 'windowskin_name',
                     'title_name',
                     ...
                     'start_map_id', 'start_x', 'start_y', 'battleback_name', 'battler_name', 'battler_hue',
                     'edit_map_id')
    ...
    def apply_extra(self):
        ...
        try:
            if self.data.has_key("passages"):
                ...
                if not result:
                    raise StandardError("'Apply' Sub action failed: %s" % self.passages_action)
            if self.data.has_key("priorities"):
                ...
                if not result:
                    raise StandardError("'Apply' Sub action failed: %s" % self.priorities_action)
            if self.data.has_key("terrain_tags"):
                self.terrain_tags_action = TableEditAction(self.obj.terrain_tags, self.data["terrain_tags"],
                                                           sub_action=True)
                result &= self.terrain_tags_action.apply()
                actions_now.append(self.terrain_tags_action)
                if not result:
                    raise StandardError("'Apply' Sub action failed: %s" % self.terrain_tags_action)
        except StandardError:
            ...
            try:
                ...
                Kernel.Log("Exception reverting failed 'Apply' Tileset Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
            result = False
        return result
    ...
    def undo_extra(self):
        ...
        try:
            if self.passages_action is not None:
                ...
                actions_now.append(self.passages_action)
                if not result:
                    raise StandardError("'Undo' Sub action failed: %s" % self.passages_action)
            if self.priorities_action is not None:
                result &= self.priorities_action.undo()
                actions_now.append(self.priorities_action)
                if not result:
                    raise StandardError("'Undo' Sub action failed: %s" % self.priorities_action)
            if self.terrain_tags_action is not None:
                result &= self.terrain_tags_action.undo()
                actions_now.append(self.terrain_tags_action)
                if not result:
                    raise StandardError("'Undo' Sub action failed: %s" % self.terrain_tags_action)
        except StandardError:
            Kernel.Log("Exception undoing Tileset Edit Action, will attempt to revert", "[DatabaseAction]", True, True)
            try:
                for action in actions_now:
                    test = action.apply()
                    if not test:
                ...
                Kernel.Log("Exception reverting failed 'Undo' Tileset Edit Action, Possible Project coruption",
                           "[DatabaseAction]", True, True)
        return result
