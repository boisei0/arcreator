...
class EventPagePanel(wx.Panel):
    def __init__(self, parent, page):
        ...
        self.foldPanel = fpb.FoldPanelBar(self, wx.ID_ANY, wx.DefaultPosition, (150, -1),
                                          agwStyle=fpb.FPB_EXCLUSIVE_FOLD)
...
class EventCondidtionsPropertiesPanel(wx.Panel):
    ...
    def setupProperties(self):
        ...
        if self.type == -1:  # blank
            ...
            self.comboBoxSwitch = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                              comboBoxSwitchChoices, 0)
            ...
            self.spinCtrlVariable = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
            ...
            self.checkBoxSelfSwitch = wx.CheckBox(self, wx.ID_ANY, u"Self Switch", wx.DefaultPosition, wx.DefaultSize,
                                                  0)
            sizerSelfSwitch.Add(self.checkBoxSelfSwitch, 0, wx.BOTTOM | wx.RIGHT | wx.LEFT | wx.ALIGN_CENTER_VERTICAL,
                                5)
            ...
            self.comboBoxSelfSwitch = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                                comboBoxSelfSwitchChoices, 0)
            ...
            self.checkBoxSelfVariable = wx.CheckBox(self, wx.ID_ANY, u"Self Variable", wx.DefaultPosition,
                                                    wx.DefaultSize, 0)
            sizerSelfVariable.Add(self.checkBoxSelfVariable, 0,
                                  wx.BOTTOM | wx.RIGHT | wx.LEFT | wx.ALIGN_CENTER_VERTICAL, 5)

            self.spinCtrlSelfVariable = wx.SpinCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                                    wx.SP_ARROW_KEYS, 0, 10, 0)
            ...
            sizerSelfVariable.Add(self.labelSelfVariable, 0, wx.BOTTOM | wx.RIGHT | wx.LEFT | wx.ALIGN_CENTER_VERTICAL,
                                  5)
            ...
            self.comboBoxScript = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                              comboBoxScriptChoices, 0)
...
class EventTriggerPanel(wx.Panel):
    def __init__(self, parent, page):
        ...
        self.radioBoxTrigger = wx.RadioBox(self, wx.ID_ANY, u"Trigger", wx.DefaultPosition, wx.DefaultSize,
...
class EventMoveRoutePanel(wx.Panel):
    def __init__(self, parent, move_route):
        ...
        self.comboBoxMoveType = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(64, -1), comboBoxMoveTypeChoices,
                                          0)
        ...
        self.comboBoxMoveSpeed = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(64, -1),
        ...
        self.comboBoxMoveFreq = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(64, -1), comboBoxMoveFreqChoices,
                                          0)
